...
#if ENABLE_60FPS == 1 // SectorY_80197F84
void SectorY_80197F84(Boss* boss) {
    f32 yaw;

    Math_SmoothStepToF(&boss->obj.pos.y, 0.0f, 0.5f DIV_FRAME_FACTOR, 15.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToF(&boss->vel.y, 0.0f, 0.1f DIV_FRAME_FACTOR, 0.2f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToF(&boss->vel.z, 0.0f, 0.1f DIV_FRAME_FACTOR, 0.2f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToF(&boss->vel.x, 0.0f, 0.1f DIV_FRAME_FACTOR, 0.2f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToAngle(&boss->rot_078.x, 0.0f, 0.1f, 4.0f, 0.1f);

    if (SectorY_8019B5CC(boss)) {
        Math_SmoothStepToF(&boss->obj.pos.y, 1000.0f, 0.1 DIV_FRAME_FACTOR, 30.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    } else {
        Math_SmoothStepToF(&boss->obj.pos.y, 0.0f, 0.1f DIV_FRAME_FACTOR, 10.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    }
    ...
    Math_SmoothStepToAngle(&boss->rot_078.y, yaw, 0.1f DIV_FRAME_FACTOR, 8.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
...
#if ENABLE_60FPS == 1 // SectorY_80198244
void SectorY_80198244(Boss* boss) {
    ...
    if (speed < 5.0f) {
        Math_SmoothStepToF(&boss->vel.x, boss->fwork[11], 0.1f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    }
    speed = ABS(boss->vel.z);

    if (speed < 5.0f) {
        Math_SmoothStepToF(&boss->vel.z, boss->fwork[13], 0.1f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    }
...
#if ENABLE_60FPS == 1 // SectorY_801983E4
void SectorY_801983E4(Boss* boss) {
    ...
    Math_SmoothStepToAngle(&boss->rot_078.z, 0.0f, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToAngle(&boss->rot_078.x, 0.0f, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToF(&boss->vel.x, boss->fwork[11], 0.1f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToF(&boss->vel.z, boss->fwork[13], 0.1f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToF(&boss->vel.y, 0.0f, 0.1f DIV_FRAME_FACTOR, 0.2f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    ...
    if (boss->rot_078.x != 0.0f) {
        Math_SmoothStepToAngle(&boss->rot_078.x, boss->fwork[10], 0.1f DIV_FRAME_FACTOR, 6.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
        ...
        if ((zSpeed < 3400.0f) || (xSpeed < 2400.0f)) {
            ...
            if (((yAngle > 300.0f) || (yAngle < 60.0f)) && (boss->rot_078.x == 0.0f)) {
                if (Rand_ZeroOne() < 0.3f) {
                    ...
                    Math_SmoothStepToAngle(&boss->rot_078.x, 181.0f, 0.1f DIV_FRAME_FACTOR, 6.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
                    boss->swork[21] = 3;
    ...
    if (SectorY_8019B5CC(boss)) {
        Math_SmoothStepToF(&boss->obj.pos.y, 1000.0f, 0.1f DIV_FRAME_FACTOR, 30.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    } else {
        Math_SmoothStepToF(&boss->obj.pos.y, 0.0f, 0.1f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    }
...
#if ENABLE_60FPS == 1 // SectorY_80198ABC
void SectorY_80198ABC(Boss* boss) {
    ...
    D_ctx_80177A10[8] += ((gGameFrameCount % (2U MUL_FRAME_FACTOR)) + 1) DIV_FRAME_FACTOR; //??????
    D_ctx_80177A10[8] %= 4U;
}
#else
void SectorY_80198ABC(Boss* boss) {
...
#if ENABLE_60FPS == 1 // SectorY_80198CE4
void SectorY_80198CE4(Boss* boss) {
    ...
    Math_SmoothStepToAngle(&boss->rot_078.z, boss->fwork[27], 0.1f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToAngle(&boss->rot_078.x, 0.0f, 0.1f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    yAngle = Math_RadToDeg(Math_Atan2F(-boss->obj.pos.x, -300.0f - boss->obj.pos.z));

    if (boss->index != 0) {
        Math_SmoothStepToAngle(&boss->rot_078.y, yAngle, 0.1f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    } else {
        Math_SmoothStepToAngle(&boss->rot_078.y, yAngle, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    }
    ...
    Math_SmoothStepToF(&boss->vel.y, 0.0f, 0.1f, 0.2f DIV_FRAME_FACTOR DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);

    yAngle -= boss->rot_078.y DIV_FRAME_FACTOR;
    if (yAngle < 0.0f) {
        yAngle += 360.0f;
    }
...
#if ENABLE_60FPS == 1 // SectorY_80198F5C
...
#if ENABLE_60FPS == 1 // SectorY_80199438
void SectorY_80199438(Boss* boss) {
    ...
    if (boss->health <= 0) {
        if (boss->index == 0) {
            ...
            if (gCsFrameCount < 61 MUL_FRAME_FACTOR) {
                boss->fwork[0] = 0.0f;
            }
            if (gCsFrameCount == 61 MUL_FRAME_FACTOR) {
                Radio_PlayMessage(gMsg_ID_14360, RCID_BOSS_SECTORY);
            }
            if (gCsFrameCount >= 80 MUL_FRAME_FACTOR) {
                boss->fwork[0] = 1.0f;
            }
        } else {
            D_ctx_80177A48[8] += D_ctx_80177A48[9] DIV_FRAME_FACTOR;
            Matrix_RotateY(gCalcMatrix, D_ctx_80177A48[8] * M_DTOR, MTXF_NEW);
            ...
            Math_SmoothStepToF(&gPlayer[0].cam.eye.x, gCsCamEyeX, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 20000.0f DIV_FRAME_FACTOR, 0);
            Math_SmoothStepToF(&gPlayer[0].cam.eye.y, gCsCamEyeY, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 20000.0f DIV_FRAME_FACTOR, 0);
            Math_SmoothStepToF(&gPlayer[0].cam.eye.z, gCsCamEyeZ, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 20000.0f DIV_FRAME_FACTOR, 0);
            Math_SmoothStepToF(&gPlayer[0].cam.at.x, gCsCamAtX, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 20000.0f DIV_FRAME_FACTOR, 0);
            Math_SmoothStepToF(&gPlayer[0].cam.at.y, gCsCamAtY, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 20000.0f DIV_FRAME_FACTOR, 0);
            Math_SmoothStepToF(&gPlayer[0].cam.at.z, gCsCamAtZ, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 20000.0f DIV_FRAME_FACTOR, 0);
        }
...
#if ENABLE_60FPS == 1 // SectorY_80199DAC
void SectorY_80199DAC(Boss* boss) {
    ...
    Math_SmoothStepToAngle(&boss->rot_078.z, 0.0f, 0.1f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToAngle(&boss->rot_078.y, boss->fwork[10], 0.1f DIV_FRAME_FACTOR, 6.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToF(&boss->obj.pos.y, boss->fwork[12], 1.0f DIV_FRAME_FACTOR, 15.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
    ...
    if (((ABS(boss->obj.pos.y) - boss->fwork[12]) <= 1800.0f) && (ABS(boss->obj.pos.x) <= 1800.0f) &&
        ...
        Math_SmoothStepToF(&boss->obj.pos.x, 0.0f, 0.1f DIV_FRAME_FACTOR, ABS(boss->fwork[11]) DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
        Math_SmoothStepToF(&boss->obj.pos.z, -300.0f, 0.1f DIV_FRAME_FACTOR, ABS(boss->fwork[13]) DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
        Math_SmoothStepToAngle(&boss->rot_078.x, 0.0f, 0.1f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
        ...
        if (((ABS(boss->obj.pos.y) - boss->fwork[12]) <= 300.0f) && (ABS(boss->obj.pos.x) <= 300.0f) &&
            ...
            Math_SmoothStepToF(&boss->fwork[43], 3.0f, 0.1f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            boss->swork[21] = 6;
            boss->unk_04C = 27;
        ...
        if (boss->rot_078.x != 0.0f) {
            if ((yAngle > 300.0f) || (yAngle < 60.0f)) {
                ...
                Math_SmoothStepToAngle(&boss->rot_078.x, 0.0f, 0.1f DIV_FRAME_FACTOR, 6.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            }
...
#if ENABLE_60FPS == 1 // SectorY_8019A520
void SectorY_8019A520(Boss* boss) {
    ...
    Math_SmoothStepToAngle(&boss->rot_078.y, 0.0f, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToF(&boss->vel.x, 0.0f, 0.1f DIV_FRAME_FACTOR, 0.2f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToF(&boss->vel.z, 6.0f, 0.1f DIV_FRAME_FACTOR, 0.2f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    Math_SmoothStepToF(&boss->vel.y, 0.0f, 0.1f DIV_FRAME_FACTOR, 0.2f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
...
#if ENABLE_60FPS == 1 // SectorY_8019A66C
void SectorY_8019A66C(Boss* boss) {
    ...
    if (boss->timer_056 <= 60) {
        ...
        boss->fwork[13] = COS_DEG(boss->rot_078.y) * boss->fwork[45];
        boss->swork[21] = 1;
        Math_SmoothStepToF(&boss->fwork[43], 0.0f, 0.1f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
        Math_SmoothStepToF(&boss->vel.z, boss->fwork[13], 0.1f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR);
        Math_SmoothStepToF(&boss->vel.x, boss->fwork[11], 0.1f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR);
        Math_SmoothStepToF(&boss->vel.y, 10.0f, 0.1f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR);
    }
...
#if ENABLE_60FPS == 1 // SectorY_8019A898
void SectorY_8019A898(Boss* boss) {
    ...
    if (((yAngle2 >= 30.0f) && (yAngle2 <= 330.0f)) || ((boss->unk_04C != 0)) && (boss->unk_04C != 27)) {
        boss->swork[21] = 5;
        Math_SmoothStepToAngle(&boss->rot_078.y, yAngle1, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
        boss->fwork[0] = 1.0f;
        if ((boss->unk_04C == 0) || (boss->unk_04C == 27)) {
            AUDIO_PLAY_SFX(NA_SE_EN_HEAVY_WALK, boss->sfxSource, 4);
        }
...
#if ENABLE_60FPS == 1 // SectorY_8019AAF0
void SectorY_8019AAF0(Boss* boss) {
    ...
    if (boss->unk_04C >= boss->swork[32] - 29) {
        ...
        Math_SmoothStepToF(&boss->fwork[9], boss->fwork[45] + 10.0f, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
        ...
        boss->vel.z = vel.z;
        boss->vel.x = vel.x;
        Math_SmoothStepToAngle(&boss->rot_078.y, Math_RadToDeg(yAngle), 0.1f DIV_FRAME_FACTOR, 6.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
    }

    if (boss->swork[31] != 11) {

        if ((boss->rot_078.z <= 90.0f) || (boss->rot_078.z >= 270.0f)) {
            boss->fwork[19] += 70.0f DIV_FRAME_FACTOR;
        } else {
            boss->fwork[19] -= 50.0f DIV_FRAME_FACTOR;
        }
    }

    Math_SmoothStepToF(&boss->obj.pos.y, boss->fwork[19], 0.1f DIV_FRAME_FACTOR, 40.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
...
#if ENABLE_60FPS == 1 // SectorY_8019AEEC
void SectorY_8019AEEC(Boss* boss) {
    if ((boss->obj.pos.y != 365.0f) && (boss->swork[21] != 1)) {
        if (boss->unk_04A != 0) {
            ...
            Math_SmoothStepToF(&boss->obj.pos.y, 365.0f, 0.1f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            Math_SmoothStepToF(&gActors[59].obj.pos.y, 153.0f, 0.1f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            Math_SmoothStepToF(&gPlayer[0].cam.eye.z, -28300.0f, 1.0f DIV_FRAME_FACTOR, 100.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);

            if (gPlayer[0].cam.eye.z == -28300.0f) {
                Math_SmoothStepToF(&boss->fwork[46], 128.0f, 1.0f DIV_FRAME_FACTOR, 16.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
        ...
        Math_SmoothStepToF(&gPlayer[0].cam.eye.z, -29000.0f, 1.0f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
        Math_SmoothStepToF(&gPlayer[0].cam.eye.x, 2000.0f, 1.0f DIV_FRAME_FACTOR, 8.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
        Math_SmoothStepToF(&boss->fwork[46], 0.0f, 1.0f DIV_FRAME_FACTOR, 16.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
        ...
        if (boss->timer_056 < 96) {
            Math_SmoothStepToF(&gActors[59].fwork[0], 0.0f, 0.1f DIV_FRAME_FACTOR, 0.2f DIV_FRAME_FACTOR, 0.05f DIV_FRAME_FACTOR);
            if (boss->timer_056 > 55) {
                Math_SmoothStepToF(&boss->vel.z, 80.0f, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR);
                Math_SmoothStepToF(&gActors[59].vel.z, 80.0f, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR);
                if (((gGameFrameCount % (2 MUL_FRAME_FACTOR)) == 0)) {
                    func_effect_8007C120(boss->obj.pos.x, boss->obj.pos.y - 150.0f, boss->obj.pos.z, 0.0f, 0.0f, 0.0f, 0.1f, 5);
                }
            }
        }
        if (boss->timer_056 == 55) {
        ...
        if (boss->timer_056 <= 55) {
            boss->swork[21] = 1;
            Math_SmoothStepToF(&boss->fwork[43], 0.0f, 0.1f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            Math_SmoothStepToF(&boss->vel.y, 20.0f, 0.1f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR);
            Math_SmoothStepToF(&gActors[59].vel.z, 0.0f, 0.1f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR);
        }
...
#if ENABLE_60FPS == 1 // SectorY_8019C194
void SectorY_8019C194(Boss* boss, f32 zSpeed, f32 xSpeed) {
    ...
    if ((gBossFrameCount > 250) && (boss->fwork[34] == 2.8f)) {
        ...
        D_ctx_80177A10[8] += (gGameFrameCount % 2U MUL_FRAME_FACTOR) + 1;
        D_ctx_80177A10[8] %= 4U;
    }

    if ((xSpeed > 800.0f) || (zSpeed > 300.0f)) {
        boss->fwork[44] += 8.0f DIV_FRAME_FACTOR;
        ...
        if (boss->index == 0) {
            ...
            boss->obj.pos.x += sp2C DIV_FRAME_FACTOR;

            sp28 = SIN_DEG(boss->fwork[44]) * ABS(boss->vel.x * 1.5f);
            boss->obj.pos.z += sp28 DIV_FRAME_FACTOR;
        } else {
        ...
        if (!SectorY_8019B5CC(boss)) {
            if (boss->index == 0) {
                boss->obj.pos.y += (SIN_DEG(boss->fwork[44]) * 30.0f) DIV_FRAME_FACTOR;
            } else {
                boss->obj.pos.y += (SIN_DEG(boss->fwork[44]) * 10.0f) DIV_FRAME_FACTOR;
            }
        }
...
#if ENABLE_60FPS == 1 // SectorY_Boss_Update
void SectorY_Boss_Update(Boss* boss) {
    ...
    if (gPlayer[0].state_1C8 != PLAYERSTATE_1C8_START_360) {
        ...
        if (boss->index == 2) {
            if ((ABS(boss->obj.pos.x - gBosses[1].obj.pos.x) < 800.0f) &&
                ...
                if (ABS(boss->obj.pos.y - gBosses[1].obj.pos.y) <= 800.0f) {
                    boss->obj.pos.y += 20.0f DIV_FRAME_FACTOR;
                    gBosses[1].obj.pos.y -= 20.0f DIV_FRAME_FACTOR;
                }
            }
        }
        ...
        if ((boss->swork[29] != 0) && !(boss->swork[29] & gGameFrameCount DIV_FRAME_FACTOR)) {
            func_effect_8007C120(boss->obj.pos.x, boss->obj.pos.y, boss->obj.pos.z, boss->vel.x, boss->vel.y,
                                 boss->vel.z, 0.1f, 5);
        }
        ...
        if ((boss->health > 0) && (boss->swork[20] < 10)) {
            ...
            Math_SmoothStepToAngle(&boss->fwork[6], sp1E4, 0.2f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            Math_SmoothStepToAngle(&boss->fwork[5], sp1E8, 0.2f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            ...
            Math_SmoothStepToAngle(&boss->fwork[8], sp1E0, 0.4f DIV_FRAME_FACTOR, 8.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            Math_SmoothStepToAngle(&boss->fwork[7], sp1DC, 0.4f DIV_FRAME_FACTOR, 8.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            ...
            Math_SmoothStepToAngle(&boss->fwork[15], sp1D8, 0.2f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            Math_SmoothStepToAngle(&boss->fwork[14], sp1D4, 0.2f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            ...
            Math_SmoothStepToAngle(&boss->fwork[17], sp1E4, 0.2f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            Math_SmoothStepToAngle(&boss->fwork[16], sp1E8, 0.2f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
        } else {
            Math_SmoothStepToAngle(&boss->fwork[6], 0.0f, 0.2f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            Math_SmoothStepToAngle(&boss->fwork[5], 0.0f, 0.2f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            Math_SmoothStepToAngle(&boss->fwork[8], 0.0f, 0.4f DIV_FRAME_FACTOR, 8.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            Math_SmoothStepToAngle(&boss->fwork[7], 0.0f, 0.4f DIV_FRAME_FACTOR, 8.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            Math_SmoothStepToAngle(&boss->fwork[15], 0.0f, 0.4f DIV_FRAME_FACTOR, 8.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
            Math_SmoothStepToAngle(&boss->fwork[14], 0.0f, 0.4f DIV_FRAME_FACTOR, 8.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR);
        }
        Math_SmoothStepToF(&boss->fwork[4], 0.0f, 0.2f DIV_FRAME_FACTOR, 10.0f DIV_FRAME_FACTOR, 0.0f);
        Math_SmoothStepToF(&boss->fwork[34], 0.0f, 0.1f DIV_FRAME_FACTOR, 0.2f DIV_FRAME_FACTOR, 0.05f DIV_FRAME_FACTOR);
        Math_SmoothStepToF(&boss->fwork[41], 0.0f, 0.1f DIV_FRAME_FACTOR, 0.05f DIV_FRAME_FACTOR, 0.05f DIV_FRAME_FACTOR);
        Math_SmoothStepToF(&boss->fwork[42], 0.0f, 0.1f DIV_FRAME_FACTOR, 0.05f DIV_FRAME_FACTOR, 0.05f DIV_FRAME_FACTOR);
        Math_SmoothStepToVec3fArray(sp64, boss->vwork, 1, sp1D0, boss->fwork[0] DIV_FRAME_FACTOR, 100.0f DIV_FRAME_FACTOR, 0.0f);
...
#if ENABLE_60FPS == 1 // SectorY_LevelComplete
void SectorY_LevelComplete(Player* player) {
    ...
    switch (player->csState) {
        ...
        case 1:
            ...
            temp_ft1 = Math_SmoothStepToAngle(&player->rot.y, 283.0f, 0.1f DIV_FRAME_FACTOR, 3.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(&player->rot.z, temp_ft1 * 20.0f, 0.1f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0);

            for (i = 1; i < 4; i++) {
                temp_ft1 = Math_SmoothStepToAngle(&gActors[i].rot_0F4.y, gActors[i].fwork[1], 0.1f DIV_FRAME_FACTOR, 3.0f DIV_FRAME_FACTOR, 0.0f);
                Math_SmoothStepToF(&gActors[i].rot_0F4.z, temp_ft1 * 20.0f, 0.1f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0);
            }
        ...
        case 3:
            ...
            if (gCsFrameCount == 343 MUL_FRAME_FACTOR) {
                AUDIO_PLAY_SFX(NA_SE_WING_OPEN, player->sfxSource, 0);
            }
            if (gCsFrameCount == 395 MUL_FRAME_FACTOR) {
            ...
            Math_SmoothStepToF(&D_ctx_80177A48[9], 3400.0f, 1.0f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR, 0.0f);

            if (D_ctx_80177A48[1] >= 93.0f) {
                if (gCsFrameCount < 1380 MUL_FRAME_FACTOR) {
                    Math_SmoothStepToF(&D_ctx_80177A48[7], 300.0f, 1.0f DIV_FRAME_FACTOR, 0.7f DIV_FRAME_FACTOR, 0.0f);
                } else {
                    D_ctx_80177A48[7] -= 5.0f DIV_FRAME_FACTOR;
                }
            }

            if (gCsFrameCount >= 640 MUL_FRAME_FACTOR) {
                Math_SmoothStepToF(&D_ctx_80177A48[6], 1.0f, 0.1f DIV_FRAME_FACTOR, 0.025f DIV_FRAME_FACTOR, 0.0f);
                Math_SmoothStepToF(&D_ctx_80177A48[8], 1600.0f, 1.0f DIV_FRAME_FACTOR, D_ctx_80177A48[6] DIV_FRAME_FACTOR, 0.0f);
            } else {
                Math_SmoothStepToF(&D_ctx_80177A48[8], 350.0f, 0.1f DIV_FRAME_FACTOR, 0.7f DIV_FRAME_FACTOR, 0.0f);
            }
            gCsCamEyeX = sp54.x;
            ...
            if (gCsFrameCount > 1440 MUL_FRAME_FACTOR) {
                ...
                Math_SmoothStepToF(&D_ctx_80177A48[2], 0.3f, 1.0f DIV_FRAME_FACTOR, 0.0018f DIV_FRAME_FACTOR, 0);
            } else {
                Math_SmoothStepToF(&D_ctx_80177A48[2], 0.01f, 1.0f DIV_FRAME_FACTOR, 0.0016f DIV_FRAME_FACTOR, 0);
            }

            if (gCsFrameCount > 1530 MUL_FRAME_FACTOR) {
                gFillScreenAlphaTarget = 255;
...
#if ENABLE_60FPS == 1 // SectorY_8019FF00
void SectorY_8019FF00(Actor* actor) {
    ...
    switch (actor->state) {
        case 1:
            Math_SmoothStepToF(&actor->obj.pos.x, actor->vwork[0].x, 0.02f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0001f DIV_FRAME_FACTOR);
            Math_SmoothStepToF(&actor->obj.pos.y, actor->vwork[0].y, 0.02f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0001f DIV_FRAME_FACTOR);
            Math_SmoothStepToF(&actor->obj.pos.z, actor->vwork[0].z, 0.02f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0001f DIV_FRAME_FACTOR);
            Math_SmoothStepToF(&actor->rot_0F4.z, 0.0f, 0.02f, 0.2f, 0.0001f);
            if ((actor->animFrame != 0) && ((((s32) (actor->index % 8U) * 10) + 1030) < gCsFrameCount DIV_FRAME_FACTOR)) {
                actor->state = 4;
            }
            break;
        ...
        case 3:
            actor->iwork[11] = 2;
            actor->fwork[0] += 2.0f DIV_FRAME_FACTOR;
            actor->rot_0F4.x += 0.1f DIV_FRAME_FACTOR;
            break;

        case 5:
            Math_SmoothStepToF(&actor->rot_0F4.x, 0.0f, 0.1f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.0f);
            temp1 = actor->obj.pos.x - gBosses[actor->timer_04C].obj.pos.x;
            temp2 = actor->obj.pos.z - gBosses[actor->timer_04C].obj.pos.z;

            var2 = Math_RadToDeg(Math_Atan2F(temp1, temp2));
            _2ndarg = Math_SmoothStepToAngle(&actor->rot_0F4.y, var2 MUL_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0001f DIV_FRAME_FACTOR);
            Math_SmoothStepToAngle(&actor->rot_0F4.z, _2ndarg MUL_FRAME_FACTOR * 30.0f, 0.1f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.0001f DIV_FRAME_FACTOR);
            break;

        case 7:
            actor->rot_0F4.y = gPlayer[0].rot.y;
            actor->rot_0F4.z = gPlayer[0].rot.z;
            Math_SmoothStepToF(&actor->obj.pos.y, 50.0f, 0.1f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
            if (gPlayer[0].rot.y == 0.0f) {
                Math_SmoothStepToF(&actor->obj.pos.x, 1300.0f, 1.0f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);
            } else {
                if (gCsFrameCount == 540) {
                    actor->fwork[29] = 3.8f;
                    AUDIO_PLAY_SFX(NA_SE_ARWING_BOOST, actor->sfxSource, 0);
                }
                Math_SmoothStepToF(&actor->obj.pos.x, 230.0f, 1.0f DIV_FRAME_FACTOR, 13.0f DIV_FRAME_FACTOR, 0.0f);
            }
            break;

        case 8:
            Math_SmoothStepToF(&actor->obj.pos.y, -100.0f, 0.1f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
            if (gCsFrameCount >= 535 MUL_FRAME_FACTOR) {
                if (gCsFrameCount == 535 MUL_FRAME_FACTOR) {
                    actor->fwork[29] = 3.8f;
                    AUDIO_PLAY_SFX(NA_SE_ARWING_BOOST, actor->sfxSource, 0);
                }
                Math_SmoothStepToF(&actor->obj.pos.x, -1000.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                Math_SmoothStepToAngle(&actor->rot_0F4.z, 45.0f, 1.0f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.0f);
            } else {
                actor->rot_0F4.y = gPlayer[0].rot.y;
                actor->rot_0F4.z = gPlayer[0].rot.z;
                Math_SmoothStepToF(&actor->obj.pos.x, -230.0f, 1.0f DIV_FRAME_FACTOR, 13.0f DIV_FRAME_FACTOR, 0.0f);
        ...
        case 9:
            Math_SmoothStepToF(&actor->obj.pos.y, -50.0f, 0.1f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
            if (gCsFrameCount >= 525 MUL_FRAME_FACTOR) {
                if (gCsFrameCount == 525 MUL_FRAME_FACTOR) {
                    actor->fwork[29] = 3.8f;
                    AUDIO_PLAY_SFX(NA_SE_ARWING_BOOST, actor->sfxSource, 0);
                }
                Math_SmoothStepToF(&actor->obj.pos.x, 1500.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                Math_SmoothStepToAngle(&actor->rot_0F4.z, 315.0f, 1.0f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);
            } else {
                actor->rot_0F4.y = gPlayer[0].rot.y;
                actor->rot_0F4.z = gPlayer[0].rot.z;
                Math_SmoothStepToF(&actor->obj.pos.x, 150.0f, 1.0f DIV_FRAME_FACTOR, 13.0f DIV_FRAME_FACTOR, 0.0f);
            }
            break;
    }
...
#if ENABLE_60FPS == 1 // SectorY_801A0AC0 *levelstart cutscene
void SectorY_801A0AC0(Player* player) {
    ...
    switch (player->csState) {
        ...
        case 1:
            ...
            if ((((gCsFrameCount) % (4 MUL_FRAME_FACTOR)) == 0)) { // Carrier shoots at enimes
                ...
                for (i = 0; i < 10; i++) {
                    if (gPlayerShots[i].obj.status == SHOT_FREE) {
                        Actor_SetupPlayerShot(PLAYERSHOT_TWIN_LASER, &gPlayerShots[i], CS_SHOT_ID, gActors[8].obj.pos.x, gActors[8].obj.pos.y - 200.0f, sp80, sp98.x, sp98.y, sp98.z, sp88, sp84, 0.0f);
            ...
            if (gCsFrameCount >= (100 MUL_FRAME_FACTOR)) { // enimies fly towrard ship
                gCsCamAtX = gActors[5].obj.pos.x;
                gCsCamAtY = 0.0f;
                gCsCamAtZ = gActors[5].obj.pos.z;
                Math_SmoothStepToF(D_ctx_80177A48, 1.0f, 1.0f DIV_FRAME_FACTOR, 0.005f DIV_FRAME_FACTOR, 0.0f);
            ...
            if (gCsFrameCount >= (189 MUL_FRAME_FACTOR)) { // enimies fly towrard ship continued
                ...
                if (((gGameFrameCount % (16 MUL_FRAME_FACTOR)) == 0) && (gCsFrameCount >= (105 MUL_FRAME_FACTOR)) && (gCsFrameCount <= (140 MUL_FRAME_FACTOR))) {
                ...
                if (gCsFrameCount >= (140 MUL_FRAME_FACTOR)) {
                    Math_SmoothStepToAngle(&gActors[5].obj.rot.z, 0.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToAngle(&gActors[6].obj.rot.z, 0.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToAngle(&gActors[7].obj.rot.z, 0.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&gActors[5].obj.pos.y, 0.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&gActors[6].obj.pos.y, -300.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&gActors[7].obj.pos.y, 200.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&gActors[5].obj.pos.z, -900.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&gActors[6].obj.pos.z, -1570.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&gActors[7].obj.pos.z, -400.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                } else {
                    Math_SmoothStepToAngle(&gActors[5].obj.rot.z, 30.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToAngle(&gActors[6].obj.rot.z, 30.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToAngle(&gActors[7].obj.rot.z, 320.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&gActors[5].obj.pos.y, -1000.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&gActors[6].obj.pos.y, 500.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&gActors[7].obj.pos.y, -400.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&gActors[5].obj.pos.z, -1200.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&gActors[6].obj.pos.z, -2070.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                    Math_SmoothStepToF(&gActors[7].obj.pos.z, -100.0f, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                }
            }

            if (((gGameFrameCount % (2 MUL_FRAME_FACTOR)) == 0) && (gCsFrameCount >= (110 MUL_FRAME_FACTOR))) {
            ...
            if ((gGameFrameCount & (20 MUL_FRAME_FACTOR)) != 0) {
            ...
            if ((gCsFrameCount >= (240 MUL_FRAME_FACTOR)) && (gCsFrameCount < (260 MUL_FRAME_FACTOR))) {
                gActors[9].scale += 32.0f DIV_FRAME_FACTOR;
                if (gCsFrameCount >= (245 MUL_FRAME_FACTOR)) {
                    gActors[9].fwork[4] += 8 DIV_FRAME_FACTOR;
                    gFillScreenRed = 255;
            ...
            switch (gCsFrameCount) {
                ...
                case 155 MUL_FRAME_FACTOR:
                    gActors[7].fwork[0] = 3.8f;
                    AUDIO_PLAY_SFX(NA_SE_EN_MS_DASH, gActors[7].sfxSource, 4);
                    break;

                case 163 MUL_FRAME_FACTOR:
                    gActors[6].fwork[0] = 3.8f;
                    AUDIO_PLAY_SFX(NA_SE_EN_MS_DASH, gActors[6].sfxSource, 4);
                    break;

                case 240 MUL_FRAME_FACTOR:
        ...
        case 2:
            if (gCsFrameCount < (300 MUL_FRAME_FACTOR)) {
                gFillScreenRed = 255;
                gFillScreenGreen = 255;
                gFillScreenBlue = 255;
                gFillScreenAlpha = 255;
            ...
            if (gCsFrameCount >= (300 MUL_FRAME_FACTOR)) {
                Math_SmoothStepToF(&D_ctx_80177A48[1], 120.0f, 0.1f DIV_FRAME_FACTOR, D_ctx_80177A48[2] DIV_FRAME_FACTOR, 0);
                Math_SmoothStepToF(&D_ctx_80177A48[2], 2.0f, 0.1f DIV_FRAME_FACTOR, 0.05f DIV_FRAME_FACTOR, 0);
                Math_SmoothStepToF(&D_ctx_80177A48[3], 100.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0);
                Math_SmoothStepToF(&D_ctx_80177A48[4], 400.0f, 1.0f DIV_FRAME_FACTOR, 10.0f DIV_FRAME_FACTOR, 0);
            ...
            if ((gCsFrameCount >= (285 MUL_FRAME_FACTOR)) && (gActors[9].iwork[3] != 0)) {
            ...
            if (gCsFrameCount >= (280 MUL_FRAME_FACTOR)) {
                ...
                Math_SmoothStepToF(&gActors[5].obj.pos.x, 0.0f, 1.0f DIV_FRAME_FACTOR, gActors[5].fwork[5] DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                Math_SmoothStepToF(&gActors[6].obj.pos.x, -320.0f, 1.0f DIV_FRAME_FACTOR, gActors[6].fwork[5] DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                Math_SmoothStepToF(&gActors[7].obj.pos.x, -660.0f, 1.0f DIV_FRAME_FACTOR, gActors[7].fwork[5] DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
            }
            if ((gCsFrameCount >= (320 MUL_FRAME_FACTOR)) && (gCsFrameCount <= (340 MUL_FRAME_FACTOR))) {
                gActors[5].fwork[5] -= 1.0f DIV_FRAME_FACTOR;
                gActors[5].iwork[4] = 5;
                gActors[5].iwork[5] = 19;
                if (gActors[5].obj.rot.x >= 320.0f) {
                    gActors[5].obj.rot.x -= 2.0f DIV_FRAME_FACTOR;
                }
            }
            if ((gCsFrameCount >= (330 MUL_FRAME_FACTOR)) && (gCsFrameCount <= (350 MUL_FRAME_FACTOR))) {
                gActors[6].fwork[5] -= 1.0f DIV_FRAME_FACTOR;
                gActors[6].iwork[4] = 5;
                gActors[6].iwork[5] = 19;
                if (gActors[6].obj.rot.x >= 320.0f) {
                    gActors[6].obj.rot.x -= 2.0f DIV_FRAME_FACTOR;
                }
            }
            if ((gActors[7].iwork[4] != 3) && (gCsFrameCount >= (340 MUL_FRAME_FACTOR))) {
                gActors[7].fwork[5] -= 1.0f DIV_FRAME_FACTOR;
                gActors[7].iwork[4] = 5;
                gActors[7].iwork[5] = 19;
                if (gActors[7].obj.rot.x >= 320.0f) {
                    gActors[7].obj.rot.x -= 1.0f DIV_FRAME_FACTOR;
                }
            }
            if ((gCsFrameCount >= (340 MUL_FRAME_FACTOR)) && (gCsFrameCount < (360 MUL_FRAME_FACTOR))) {
                gActors[5].fwork[5] -= 2.8f DIV_FRAME_FACTOR;
                gActors[5].iwork[4] = 1;
            ...
            if ((gCsFrameCount >= (350 MUL_FRAME_FACTOR)) && (gCsFrameCount < (370 MUL_FRAME_FACTOR))) {
                gActors[6].fwork[5] -= 2.8f DIV_FRAME_FACTOR;
                gActors[6].iwork[4] = 1;
                ...
                if (gActors[6].obj.rot.y >= 60.0f) {
                    gActors[6].obj.rot.y -= 2.0f DIV_FRAME_FACTOR;
                }
            }
            if ((gCsFrameCount >= (360 MUL_FRAME_FACTOR)) && (gCsFrameCount < (370 MUL_FRAME_FACTOR))) {
                gActors[7].fwork[5] -= 2.8f DIV_FRAME_FACTOR;
                gActors[7].iwork[4] = 3;
                gActors[7].iwork[5] = 29;
                if (gActors[7].obj.rot.x <= 360.0f) {
                    gActors[7].obj.rot.x += 2.0f DIV_FRAME_FACTOR;
                }
                if (gActors[7].obj.rot.y <= 120.0f) {
                    gActors[7].obj.rot.y += 2.0f DIV_FRAME_FACTOR;
                }
            }
            if (gCsFrameCount >= (350 MUL_FRAME_FACTOR)) {
                if (gActors[5].vel.z > -0.2f) {
                    gActors[5].vel.z -= 0.02f DIV_FRAME_FACTOR;
                }
                if (gActors[5].vel.x > -2.0f) {
                    gActors[5].vel.x -= 0.2f DIV_FRAME_FACTOR;
                }
            ...
            if (gCsFrameCount >= (360 MUL_FRAME_FACTOR)) {
                gActors[5].fwork[5] = 0.0f;
                if (gActors[6].vel.z > -2.0f) {
                    gActors[6].vel.z -= 0.2f DIV_FRAME_FACTOR;
                }
                if (gActors[6].vel.x > -2.0f) {
                    gActors[6].vel.x -= 0.15f DIV_FRAME_FACTOR;
                }
                if (gActors[7].vel.x > -1.5f) {
                    gActors[7].vel.x -= 0.2f DIV_FRAME_FACTOR;
                }
            }

            switch (gCsFrameCount) {
                case 340 MUL_FRAME_FACTOR:
                    gActors[5].fwork[0] = 1.8f;
                    AUDIO_PLAY_SFX(NA_SE_EN_MS_DASH, gActors[5].sfxSource, 4);
                    break;

                case 350 MUL_FRAME_FACTOR:
                    gActors[6].fwork[0] = 1.8f;
                    AUDIO_PLAY_SFX(NA_SE_EN_MS_DASH, gActors[6].sfxSource, 4);
                    break;

                case 370 MUL_FRAME_FACTOR:
                    gActors[6].fwork[5] = 0.0f;
                    gActors[7].fwork[5] = 0.0f;
                    break;

                case 360 MUL_FRAME_FACTOR:
                    AUDIO_PLAY_BGM(NA_BGM_START_DEMO_S);
                    break;

                case 389 MUL_FRAME_FACTOR:
                    gActors[5].iwork[4] = 1;
        ...
        case 3:
            if (gCsFrameCount < (520 MUL_FRAME_FACTOR)) {
                Math_SmoothStepToAngle(&D_ctx_80177A48[1], 120.0f, 0.1f DIV_FRAME_FACTOR, D_ctx_80177A48[2] DIV_FRAME_FACTOR, 0);
                Math_SmoothStepToF(&D_ctx_80177A48[2], 2.0f, 0.1f DIV_FRAME_FACTOR, 0.05f DIV_FRAME_FACTOR, 0);
                Math_SmoothStepToF(&D_ctx_80177A48[3], 100.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0);
                Math_SmoothStepToF(&D_ctx_80177A48[4], 400.0f, 1.0f DIV_FRAME_FACTOR, 10.0f DIV_FRAME_FACTOR, 0);

                if (gCsFrameCount <= (410 MUL_FRAME_FACTOR)) {
                    gCsCamAtX = player->cam.at.x = gActors[5].obj.pos.x;
                }
                Matrix_RotateY(gCalcMatrix, D_ctx_80177A48[1] * M_DTOR, MTXF_NEW);
                spA4.x = D_ctx_80177A48[4] + 400.0f;
            ...
            if (gCsFrameCount >= (390 MUL_FRAME_FACTOR)) {
                ...
                Math_SmoothStepToF(&gActors[6].vel.x, -40.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                Math_SmoothStepToF(&gActors[6].vel.z, -60.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
            }

            if (gCsFrameCount >= (400 MUL_FRAME_FACTOR)) {
                ...
                if ((gActors[7].iwork[5] == 35) && (gCsFrameCount == (445 MUL_FRAME_FACTOR))) {
                    gActors[7].iwork[4] = 2;
                    gActors[7].iwork[5] = 0;
                }
            }

            if ((gCsFrameCount >= (380 MUL_FRAME_FACTOR)) && (gCsFrameCount <= (460 MUL_FRAME_FACTOR))) {
                Math_SmoothStepToAngle(&gActors[5].obj.rot.y, 30.0f, 1.0f DIV_FRAME_FACTOR, 0.75f DIV_FRAME_FACTOR, 0.0f);
            }
            ...
            if (player->rot.y == 0.0f) {
                Math_SmoothStepToAngle(&player->rot.z, 0.0f, 1.0f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 0);
                Math_SmoothStepToF(&gPlayer[0].pos.x, 0.0f, 1.0f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);
            }

            if (gCsFrameCount >= (445 MUL_FRAME_FACTOR)) {
                Math_SmoothStepToF(&gActors[7].vel.z, -40.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                Math_SmoothStepToF(&gActors[7].vel.x, -60.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
            ...
            if (gCsFrameCount >= (470 MUL_FRAME_FACTOR)) {
                Math_SmoothStepToAngle(&gEnvLightyRot, 58.0f, 1.0f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);
                gActors[5].obj.rot.y += 1.2f DIV_FRAME_FACTOR;
                if (gActors[5].iwork[4] != 6) {
                    gActors[5].obj.rot.z -= 0.25f DIV_FRAME_FACTOR;
                }
                ...
                if ((gCsFrameCount >= (520 MUL_FRAME_FACTOR)) && (gCsFrameCount < (550 MUL_FRAME_FACTOR))) {
                    gActors[5].fwork[2] = 0.2f;
                    Math_SmoothStepToF(&gActors[5].vel.z, -10.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                }
                if (gCsFrameCount >= (520 MUL_FRAME_FACTOR)) {
                    ...
                    gCsCamEyeX = 50.0f;
                    gCsCamEyeY = 10.0f;
                    Math_SmoothStepToF(D_ctx_80177A48, 1.0f, 0.1f DIV_FRAME_FACTOR, 0.005f DIV_FRAME_FACTOR, 0.0f);
                }
                if ((gActors[5].iwork[4] == 6) && (gCsFrameCount >= (550 MUL_FRAME_FACTOR)) && (gActors[5].obj.rot.y <= 174.0f)) {
                    Math_SmoothStepToAngle(&gActors[5].obj.rot.z, 0.0f, 1.0f DIV_FRAME_FACTOR, 1.5f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                    gActors[5].obj.rot.y += 7.0f DIV_FRAME_FACTOR;
                ...
                if ((gActors[5].iwork[4] == 6) && (gCsFrameCount == (550 MUL_FRAME_FACTOR))) {
                    Object_Kill(&gActors[10].obj, gActors[10].sfxSource);
                    gLoadLevelObjects = 1;
                }
                if (gCsFrameCount >= (530 MUL_FRAME_FACTOR)) {
                    Math_SmoothStepToF(&gActors[5].vel.z, -40.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                    Math_SmoothStepToF(&gActors[5].vel.x, -60.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                    ...
                    Math_SmoothStepToF(&gActors[7].obj.pos.z, -8000.0f, 1.0f DIV_FRAME_FACTOR, 60.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                    Math_SmoothStepToF(&gActors[7].obj.pos.x, 3000.0f, 1.0f DIV_FRAME_FACTOR, 60.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                    Math_SmoothStepToF(&gActors[6].obj.pos.z, -8000.0f, 1.0f DIV_FRAME_FACTOR, 60.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                    Math_SmoothStepToF(&gActors[6].obj.pos.x, -3000.0f, 1.0f DIV_FRAME_FACTOR, 60.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                }
            }
            ...
            switch (gCsFrameCount DIV_FRAME_FACTOR) {
                case 390:
                    ...
                    gActors[5].vel.x -= 0.25f DIV_FRAME_FACTOR;
                    gActors[5].vel.z -= 2.0f DIV_FRAME_FACTOR;
                    break;
                ...
                case 425:
                    gActors[5].vel.x -= 0.5f DIV_FRAME_FACTOR;
                    gActors[5].vel.z -= 1.5f DIV_FRAME_FACTOR;
                    Object_Kill(&gActors[10].obj, gActors[10].sfxSource);
                    SectorY_801A07FC(&gActors[5], &gActors[10]);
                    break;
        ...
        case 4:
            Math_SmoothStepToAngle(&player->rot.z, 0.0f, 1.0f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 0);
            Math_SmoothStepToF(&gPlayer[0].pos.x, 0.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
            Math_SmoothStepToF(D_ctx_80177A48, 1.0f, 0.1f DIV_FRAME_FACTOR, 0.05f DIV_FRAME_FACTOR, 0.0f);

            if (gCsFrameCount < 595 MUL_FRAME_FACTOR) {
                Math_SmoothStepToF(&gActors[5].obj.pos.z, -12000.0f, 1.0f DIV_FRAME_FACTOR, 100.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                Math_SmoothStepToF(&gActors[5].obj.pos.x, 0.0f, 1.0f DIV_FRAME_FACTOR, 40.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                Math_SmoothStepToF(&gActors[5].obj.pos.y, 13000.0f, 1.0f DIV_FRAME_FACTOR, 30.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                Math_SmoothStepToAngle(&player->rot.y, 0.0f, 1.0f DIV_FRAME_FACTOR, 0.5f DIV_FRAME_FACTOR, 0.0f);
                Math_SmoothStepToF(&player->pos.x, 0.0f, 1.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR, 0.0f);
            } else {
                Math_SmoothStepToF(&gActors[5].obj.pos.z, -12000.0f, 1.0f DIV_FRAME_FACTOR, 100.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                Math_SmoothStepToF(&gActors[5].obj.pos.x, 300.0f, 1.0f DIV_FRAME_FACTOR, 50.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
                Math_SmoothStepToF(&gActors[5].obj.pos.y, 13000.0f, 1.0f DIV_FRAME_FACTOR, 50.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
            }
            Math_SmoothStepToF(&gActors[6].obj.pos.z, -12000.0f, 1.0f DIV_FRAME_FACTOR, 40.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);
            Math_SmoothStepToF(&gActors[6].obj.pos.x, -13000.0f, 1.0f DIV_FRAME_FACTOR, 80.0f DIV_FRAME_FACTOR, 1.0f DIV_FRAME_FACTOR);

            gCsCamAtX = player->pos.x;
            gCsCamAtZ = player->pos.z;

            if (gCsFrameCount < 590 MUL_FRAME_FACTOR) {
                gCsCamAtY = player->pos.y;
            }

            if ((gCsFrameCount >= 590 MUL_FRAME_FACTOR) && (gCsFrameCount < 605 MUL_FRAME_FACTOR)) {
                Math_SmoothStepToF(&gCsCamEyeZ, gActors[0].obj.pos.z, 1.0f DIV_FRAME_FACTOR, 20.0f DIV_FRAME_FACTOR, 0.0f);
                Math_SmoothStepToF(&gCsCamEyeX, 0.0f, 1.0f DIV_FRAME_FACTOR, 4.0f DIV_FRAME_FACTOR, 0.0f);
                Math_SmoothStepToF(&gCsCamEyeY, (player->pos.y * player->unk_148) + 50.0f, 1.0f DIV_FRAME_FACTOR, 2.25f DIV_FRAME_FACTOR, 0.0f);
                Math_SmoothStepToF(&gCsCamAtY, (player->pos.y * player->unk_148) + 20.0f, 1.0f DIV_FRAME_FACTOR, 1.5f DIV_FRAME_FACTOR, 0.0f);
            }

            if (gCsFrameCount >= 605 MUL_FRAME_FACTOR) {
                Math_SmoothStepToF(&gCsCamEyeX, 0.0f, 1.0f DIV_FRAME_FACTOR, 3.0f DIV_FRAME_FACTOR, 0.0f);
                Math_SmoothStepToF(&gCsCamEyeY, (player->pos.y * player->unk_148) + 50.0f, 1.0f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);
                Math_SmoothStepToF(&gCsCamEyeZ, player->pos.z + 400.0f, 1.0f DIV_FRAME_FACTOR, 80.0f DIV_FRAME_FACTOR, 0.0f);
                gCsCamAtZ = player->pos.z - 41.0f;
                gCsCamAtY = (player->pos.y * player->unk_148) + 20.0f;
                Math_SmoothStepToF(D_ctx_80177A48, 1.0f, 0.1f DIV_FRAME_FACTOR, 0.1f DIV_FRAME_FACTOR, 0);
            }
            ...
            if (gCsFrameCount >= 609 MUL_FRAME_FACTOR) {
    ...
    Math_SmoothStepToF(&player->cam.eye.x, gCsCamEyeX, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 20000.0f DIV_FRAME_FACTOR, 0);
    Math_SmoothStepToF(&player->cam.eye.y, gCsCamEyeY, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 20000.0f DIV_FRAME_FACTOR, 0);
    Math_SmoothStepToF(&player->cam.eye.z, gCsCamEyeZ, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 20000.0f DIV_FRAME_FACTOR, 0);
    Math_SmoothStepToF(&player->cam.at.x, gCsCamAtX, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 20000.0f DIV_FRAME_FACTOR, 0);
    Math_SmoothStepToF(&player->cam.at.y, gCsCamAtY, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 20000.0f DIV_FRAME_FACTOR, 0);
    Math_SmoothStepToF(&player->cam.at.z, gCsCamAtZ, D_ctx_80177A48[0] DIV_FRAME_FACTOR, 20000.0f DIV_FRAME_FACTOR, 0);
...
void SectorY_SetupDebris(Actor* actor, f32 xPos, f32 yPos, f32 zPos, f32 xVel, f32 yVel, f32 zVel, s32 state) {
    Actor_Initialize(actor);
    actor->obj.status = OBJ_INIT;
    actor->obj.id = OBJ_ACTOR_DEBRIS; // handled
    actor->state = state;
    actor->obj.pos.x = xPos;
    actor->obj.pos.y = yPos;
    actor->obj.pos.z = zPos;
...
#if ENABLE_60FPS == 1 // SectorY_Actor204_Update
void SectorY_Actor204_Update(Actor204* this) {
    ...
    if ((this->unk_046 == 1) || (this->unk_046 == 2)) {
        ...
        if (this->iwork[17] != 0) {
            Math_SmoothStepToAngle(&this->obj.rot.y, sp1D4, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);
    ...
    Math_SmoothStepToAngle(&this->fwork[0x15], sp1D4, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);
    Math_SmoothStepToAngle(&this->fwork[20], sp1D8, 0.1f DIV_FRAME_FACTOR, 2.0f DIV_FRAME_FACTOR, 0.0f);

    if (sp1D0 < 0.0f) {
        sp1D0 += 360.0f;
    }

    Math_SmoothStepToAngle(&this->fwork[28], sp1D0, 0.2f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.0f);
    Math_SmoothStepToAngle(&this->fwork[29], sp1D8, 0.2f DIV_FRAME_FACTOR, 5.0f DIV_FRAME_FACTOR, 0.0f);
    Math_SmoothStepToVec3fArray(sp68, this->vwork, 1, sp4C, this->fwork[15] DIV_FRAME_FACTOR, 100.0f DIV_FRAME_FACTOR, 0.0f);

    if ((this->unk_046 == 6) || (this->unk_046 == 5)) {
        Math_SmoothStepToF(&this->fwork[15], 0.3f, 1.0f DIV_FRAME_FACTOR, 0.05f DIV_FRAME_FACTOR, 0.0f);
    } else {
        Math_SmoothStepToF(&this->fwork[15], 0.2f, 1.0f DIV_FRAME_FACTOR, 0.015f DIV_FRAME_FACTOR, 0.0f);
    }
    Math_SmoothStepToF(&this->fwork[19], 0.0f, 0.2f DIV_FRAME_FACTOR, 10.0f DIV_FRAME_FACTOR, 0.0f);

    if (this->iwork[17] != 0) {
        Math_SmoothStepToF(&this->fwork[27], 1.5f, 1.0f DIV_FRAME_FACTOR, 0.2f DIV_FRAME_FACTOR, 0.0f);
    } else {
        Math_SmoothStepToF(&this->fwork[27], 0.0f, 1.0f DIV_FRAME_FACTOR, 0.05f DIV_FRAME_FACTOR, 0.0f);
    }
...
#if ENABLE_60FPS == 1 // SectorY_801A4E44
...
#if ENABLE_60FPS == 1 // SectorY_801A52B8
